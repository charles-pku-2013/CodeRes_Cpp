...
struct String : std::basic_string<char> {
    ...
    //!! 重写 move constructor 一定要用 std::move
    String( String &&rhs ) : BaseType( std::move(rhs) )
...
void test1()
{
    ...
    // String s2 = ref;  // 调String constructor @7fff5c9727b1: Hello
    /*
     * String copy constructor @7fff5c972791: Hello
     * String destructor @7fff5c972791: Hello
     * String destructor @7fff5c9727b1: Hello用普通 const ref 版本
     */
