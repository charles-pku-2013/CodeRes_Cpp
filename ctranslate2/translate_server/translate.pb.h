...
#ifndef GOOGLE_PROTOBUF_INCLUDED_translate_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_translate_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_translate_2eproto;
namespace newtranx {
namespace ai_server {
class HttpRequest;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::newtranx::ai_server::HttpRequest* Arena::CreateMaybeMessage<::newtranx::ai_server::HttpRequest>(Arena*);
template<> ::newtranx::ai_server::HttpResponse* Arena::CreateMaybeMessage<::newtranx::ai_server::HttpResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace newtranx {
namespace ai_server {
...
class HttpRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:newtranx.ai_server.HttpRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "newtranx.ai_server.HttpRequest";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_translate_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:newtranx.ai_server.HttpRequest)
 private:
  class _Internal;
...
class HttpResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:newtranx.ai_server.HttpResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "newtranx.ai_server.HttpResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:newtranx.ai_server.HttpResponse)
 private:
  class _Internal;
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_translate_2eproto
