...
class HttpRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:example.HttpRequest) */ {
 public:
  HttpRequest();
  virtual ~HttpRequest();
...
class HttpResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:example.HttpResponse) */ {
 public:
  HttpResponse();
...
class HttpSSEService : public ::google::protobuf::Service {
 protected:
  // This class should be treated as an abstract interface.
 ...
 public:
  ...
  virtual void stream(::google::protobuf::RpcController* controller,
                       const ::example::HttpRequest* request,
                       ::example::HttpResponse* response,
                       ::google::protobuf::Closure* done);
...
class HttpSSEService_Stub : public HttpSSEService {
 public:
  HttpSSEService_Stub(::google::protobuf::RpcChannel* channel);
  HttpSSEService_Stub(::google::protobuf::RpcChannel* channel,
                   ::google::protobuf::Service::ChannelOwnership ownership);
  ~HttpSSEService_Stub();
