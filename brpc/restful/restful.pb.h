...
#ifndef PROTOBUF_INCLUDED_restful_2eproto
#define PROTOBUF_INCLUDED_restful_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_restful_2eproto 
...
class HttpRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ai_matrix.HttpRequest) */ {
 public:
  HttpRequest();
  virtual ~HttpRequest();
 ...
 private:
  ...
  friend struct ::protobuf_restful_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class HttpResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ai_matrix.HttpResponse) */ {
 public:
  HttpResponse();
...
class RestfulService : public ::google::protobuf::Service {
 protected:
...
class RestfulService_Stub : public RestfulService {
 public:
  RestfulService_Stub(::google::protobuf::RpcChannel* channel);
  RestfulService_Stub(::google::protobuf::RpcChannel* channel,
...
#endif  // PROTOBUF_INCLUDED_restful_2eproto
