...
int main()
{
   ...
   //!! destroy_ptr() 是一个模板函数
   typedef boost::shared_ptr<MyShmStringVector>  MyShmStringVectorPtr;
   MyShmStringVectorPtr myshmvector(shm.construct<MyShmStringVector>("myshmvector")(stringallocator), 
					boost::bind(&managed_shared_memory::destroy_ptr<MyShmStringVector>, &shm, _1));
